...
6. <a href = "https://github.com/apj2n4/Machine-Learning-from-scratch/blob/master/Neural_Network_SGD_Regression/Regression_ANN_sgd-adam.ipynb"> Deep Neural Network with mini batch Stochastic Gradient Descent (with Adam Optimizer) for Regression - Boston Home Prices </a>
